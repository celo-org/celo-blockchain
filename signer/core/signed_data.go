...
import (
	...
	"github.com/ethereum/go-ethereum/common/typeddata"
...
type SigFormat = typeddata.SigFormat
...
type ValidatorData = typeddata.ValidatorData

type TypedData = typeddata.TypedData

type Type = typeddata.Type

type Types = typeddata.Types

type TypePriority = typeddata.TypePriority

type TypedDataMessage = typeddata.TypedDataMessage

type TypedDataDomain = typeddata.TypedDataDomain
...
type NameValueType = typeddata.NameValueType
