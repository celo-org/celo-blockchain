...
const (
	...
	MaxGasToReadErc20Balance            uint64 = 20 * 1000
	...
	AdditionalGasForNonGoldCurrencies uint64 = 3*MaxGasForCreditToTransactions + ExpectedGasForDebitFromTransactions + ExpectedGasToReadErc20Balance
)
