...
var (
	...
	reqAvgTimeCost = requestCostTable{
		...
		// TODO(plumo): Come up with better estimates here
		GetPlumoProofInventoryMsg: {0, 600000},
		GetPlumoProofsMsg:         {0, 600000},
	}
	...
	reqMaxInSize = requestCostTable{
		...
		GetPlumoProofInventoryMsg: {0, 40},
		GetPlumoProofsMsg:         {0, 240000},
	}
	...
	reqMaxOutSize = requestCostTable{
		...
		GetPlumoProofInventoryMsg: {0, 100000},
		GetPlumoProofsMsg:         {0, 100000},
	}
