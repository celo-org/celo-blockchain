...
func New(ctx *node.ServiceContext, config *eth.Config) (*LightEthereum, error) {
	...
	var fullHeaderChainAvailable bool
	...
	leth := &LightEthereum{
		...
		bloomIndexer:   eth.NewBloomIndexer(chainDb, params.BloomBitsBlocksClient, params.HelperTrieConfirmations, fullHeaderChainAvailable),
	}
	...
	leth.chtIndexer = light.NewChtIndexer(chainDb, leth.odr, params.CHTFrequencyClient, params.HelperTrieConfirmations, fullHeaderChainAvailable)
	leth.bloomTrieIndexer = light.NewBloomTrieIndexer(chainDb, leth.odr, params.BloomBitsBlocksClient, params.BloomTrieFrequency, fullHeaderChainAvailable)
	leth.odr.SetIndexers(leth.chtIndexer, leth.bloomTrieIndexer, leth.bloomIndexer)

	// Note: NewLightChain adds the trusted checkpoint so it needs an ODR with
	// indexers already set but not started yet
	if leth.blockchain, err = light.NewLightChain(leth.odr, leth.chainConfig, leth.engine, fullHeaderChainAvailable); err != nil {
		return nil, err
	}
