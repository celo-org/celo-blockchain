...
type lightChainStub struct {
	...
	tds                         map[common.Hash]*big.Int
	headers                     map[common.Hash]*types.Header
	insertHeaderChainAssertFunc func(chain []*types.Header, checkFreq int, fullHeaderChainAvailable bool) (int, error)
}
...
func (l *lightChainStub) InsertHeaderChain(chain []*types.Header, checkFreq int, fullHeaderChainAvailable bool) (int, error) {
	return l.insertHeaderChainAssertFunc(chain, checkFreq, fullHeaderChainAvailable)
}
