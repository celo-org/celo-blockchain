...
// ErrNotDeployed is returned when the RegisteredAddresses mapping does not contain the specified contract
var ErrNotDeployed = errors.New("registry contract not deployed")
