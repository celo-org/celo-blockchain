...
func setupTxPool() (*TxPool, *ecdsa.PrivateKey) {
	...
	co := NewCurrencyOperator(nil, nil)
	pool := NewTxPool(testTxPoolConfig, params.TestChainConfig, blockchain, co, nil)
...
func testTransactionQueueGlobalLimiting(t *testing.T, nolocals bool) {
	...
	co := NewCurrencyOperator(nil, nil)
	pool := NewTxPool(config, params.TestChainConfig, blockchain, co, nil)
	defer pool.Stop()
