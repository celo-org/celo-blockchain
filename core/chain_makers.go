...
func (b *BlockGen) AddTxWithChain(bc *BlockChain, tx *types.Transaction) {
	...
	receipt, _, err := ApplyTransaction(b.config, bc, &b.header.Coinbase, b.gasPool, b.statedb, b.header, tx, &b.header.GasUsed, vm.Config{}, gpm.FallbackGasPriceMinimum, gpm.FallbackInfraFraction)
	if err != nil {
		panic(err)
	}
