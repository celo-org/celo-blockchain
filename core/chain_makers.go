...
func (b *BlockGen) AddTxWithChain(bc ChainContext, tx *types.Transaction) {
	...
	receipt, _, err := ApplyTransaction(b.config, bc, &b.header.Coinbase, b.gasPool, b.header, b.statedb, tx, &b.header.GasUsed, vm.Config{})
	if err != nil {
		panic(err)
	}
...
func GenerateChain(config *params.ChainConfig, parent *types.Block, engine consensus.Engine, db ethdb.Database, n int, gen func(int, *BlockGen)) ([]*types.Block, []types.Receipts) {
	...
	genblock := func(i int, parent *types.Block, statedb *state.StateDB) (*types.Block, types.Receipts) {
		...
		if b.engine != nil {
			...
			// TODO: Should we use the Parent here in any way?
			block, _ := b.engine.Finalize(chainreader, b.header, statedb, b.txs, b.uncles, b.receipts, nil, nil)
