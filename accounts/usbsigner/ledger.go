...
const (
	ledgerOpSignHash     ledgerOpcode = 0x02 // Sign received hash output and return signature
	ledgerOpGetPublicKey ledgerOpCode = 0x04 // Return public key associated with the internal private key

	ledgerP1LastInput        ledgerParam1 = 0x80 // Last piece of streamed input data of hash
	ledgerP1NonTerminalInput ledgerParam1 = 0x00 // More data left to stream of input hash data. Should not be used currently
)
