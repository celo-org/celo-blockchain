...
TEXT ·add(SB), NOSPLIT, $0-24
	...
	MOVQ R12, SI
	MOVQ R13, BX
	MOVQ $0x8508c00000000001, DI
	SUBQ DI, R14
	MOVQ $0x170b5d4430000000, DI
	SBBQ DI, R15
	MOVQ $0x1ef3622fba094800, DI
	SBBQ DI, CX
	MOVQ $0x1a22d9f300f5138f, DI
	SBBQ DI, DX
	MOVQ $0xc63b05c06ca1493b, DI
	SBBQ DI, SI
	MOVQ $0x01ae3a4617c510ea, DI
	SBBQ DI, BX
	CMOVQCC R14, R8
	CMOVQCC R15, R9
	CMOVQCC CX, R10
...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	MOVQ $0xc63b05c06ca1493b, SI
	MOVQ $0x01ae3a4617c510ea, BX
	CMOVQCC AX, R14
	CMOVQCC AX, R15
	CMOVQCC AX, CX
	CMOVQCC AX, DX
