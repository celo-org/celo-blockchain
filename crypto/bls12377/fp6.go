...
func (e *fp6) square(c, a *fe6) {
	...
	fp2.double(t[1], t[1])      // s1 = 2a0a1
	fp2.sub(t[2], &a[0], &a[1]) // a0 - a1
	fp2.add(t[2], t[2], &a[2])  // a0 - a1 + a2
	fp2.square(t[2], t[2])      // s2 = (a0 - a1 + a2)^2
	fp2.mul(t[3], &a[1], &a[2]) // a1a2
	fp2.double(t[3], t[3])      // s3 = 2a1a2
