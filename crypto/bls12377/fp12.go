...
func (e *fp12) fromBytes(in []byte) (*fe12, error) {
	if len(in) != 12*FE_BYTE_SIZE {
		return nil, errors.New("input string should be larger than 576 bytes")
	}
	fp6 := e.fp6
...
func (e *fp12) mul(c, a, b *fe12) {
	...
	fp6.mul(t[1], &a[0], &b[0])     // a0b0
	fp6.mul(t[2], &a[1], &b[1])     // a1b1
	fp6.add(t[0], t[1], t[2])       // a0b0 + a1b1
	fp6.mulByNonResidue(t[2], t[2]) // αa1b1
	fp6.add(t[3], t[1], t[2])       // c0 = a0b0 + αa1b1
	fp6.add(t[1], &a[0], &a[1])
	fp6.add(t[2], &b[0], &b[1])
	fp6.mul(t[1], t[1], t[2])
	c[0].set(t[3])
...
func (fp12 *fp12) mul034(a *fe12, b0, b3, b4 *fe2) {
	...
	fp6.mulByNonResidue(t[1], t[1])     // αt1
	fp6.add(&a[0], t[0], t[1])          // c0 = t0 + αt1
}
