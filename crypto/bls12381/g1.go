...
func (g *G1) InCorrectSubgroup(p *PointG1) bool {
	...
	mulZ := func(p *PointG1) {
		// z = [(x^2 − 1)/3]
		z, _ := new(big.Int).SetString("76329603384216526021617858986798044501", 10)
		e := bigToWNAF(z, wnafMulWindowG1)
		g._wnafMul(p, p, e)
	}
...
func (g *G1) _wnafMul(c, p *PointG1, wnaf nafNumber) *PointG1 {
...
func (g *G1) glvMul(r, p *PointG1, e *big.Int) *PointG1 {
	return g._glvMul(r, p, new(glvVector).new(e))
}

func (g *G1) _glvMul(r, p0 *PointG1, v *glvVector) *PointG1 {
...
// MultiExp calculates multi exponentiation. Scalar values are received as big.Int type.
