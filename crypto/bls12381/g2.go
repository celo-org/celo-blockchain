...
func (g *G2) wnafMul(r, p *PointG2, e *big.Int) *PointG2 {
	wnaf := bigToWNAF(e, wnafMulWindowG2)
	return g._wnafMul(r, p, wnaf)
}

func (g *G2) _wnafMul(c, p *PointG2, wnaf nafNumber) *PointG2 {
...
func (g *G2) glvMul(r, p *PointG2, e *big.Int) *PointG2 {
	return g._glvMul(r, p, new(glvVector).new(e))
}

func (g *G2) _glvMul(r, p0 *PointG2, v *glvVector) *PointG2 {
