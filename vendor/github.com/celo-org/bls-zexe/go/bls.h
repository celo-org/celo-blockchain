...
bool sign_message(const PrivateKey*, const unsigned char*, int32_t, bool, Signature**);
bool sign_pop(const PrivateKey*, Signature**);
...
bool verify_signature(const PublicKey*, const unsigned char*, int32_t, const Signature*, bool, bool*);
