...
bool sign_message(const PrivateKey*, const unsigned char*, int32_t, Signature**);
...
bool verify_signature(const PublicKey*, const unsigned char*, int32_t, const Signature*, bool*);
