...
func New(ctx *node.ServiceContext, config *Config) (*Ethereum, error) {
	...
	eth.blockchain.Processor().SetRandom(eth.random)
	...
	eth.miner = miner.New(eth, eth.chainConfig, eth.EventMux(), eth.engine, config.MinerRecommit, config.MinerGasFloor, config.MinerGasCeil, eth.isLocalBlock, config.MinerVerificationServiceUrl, config.MinerVerificationRewards, pc, &chainDb)
