...
// SetTxFeeRecipient sets the tx fee recipient of the miner
func (api *PrivateMinerAPI) SetTxFeeRecipient(txFeeRecipient common.Address) bool {
	api.e.SetTxFeeRecipient(txFeeRecipient)
	return true
}
