...
COPY --from=rustbuilder /go-ethereum/crypto/bls/bls-zexe/target/x86_64-unknown-linux-musl/release/libbls_crypto.a /go-ethereum/crypto/bls/bls-zexe/target/release/
