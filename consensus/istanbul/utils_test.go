...
func TestSnarkValSetDiff(t *testing.T) {
	tests := []struct {
		inputOldValset       []common.Address
		inputNewValset       []common.Address
		expectedValPositions []byte
		expectedAddedVals    []common.Address
	}{
		{
			// Test validator sets that are both empty
...

		{
			...
			inputNewValset: []common.Address{common.HexToAddress("0x64DB1B94A0304E4c27De2E758B2f962d09dFE503"),
				common.HexToAddress("0xC257274276a4E539741Ca11b590B9447B26A8051"),
				common.HexToAddress("0x2140eFD7Ba31169c69dfff6CDC66C542f0211825")},
			expectedValPositions: []byte{0, 1, 2},
			expectedAddedVals:    []common.Address{},
		},

		{
			...
			inputNewValset: []common.Address{common.HexToAddress("0x64DB1B94A0304E4c27De2E758B2f962d09dFE503"),
				common.HexToAddress("0xC257274276a4E539741Ca11b590B9447B26A8051"),
				common.HexToAddress("0x2140eFD7Ba31169c69dfff6CDC66C542f0211825")},
			expectedValPositions: []byte{255, 255, 255},
			expectedAddedVals: []common.Address{common.HexToAddress("0x64DB1B94A0304E4c27De2E758B2f962d09dFE503"),
				common.HexToAddress("0xC257274276a4E539741Ca11b590B9447B26A8051"),
				common.HexToAddress("0x2140eFD7Ba31169c69dfff6CDC66C542f0211825")},
		},

		{
			...
			inputOldValset: []common.Address{common.HexToAddress("0x64DB1B94A0304E4c27De2E758B2f962d09dFE503"),
				...
				common.HexToAddress("0x2140eFD7Ba31169c69dfff6CDC66C542f0211825")},
			inputNewValset: []common.Address{},
			// TODO this doesn't match the original implementation, but I think it could be ok if I design the consumer right.
			expectedValPositions: []byte{},
			expectedAddedVals:    []common.Address{},
		},

		{
			...
			inputNewValset: []common.Address{common.HexToAddress("0x64DB1B94A0304E4c27De2E758B2f962d09dFE503"),
				...
				common.HexToAddress("0xB55A183bF5db01665f9fC5DfbA71Fc6f8b5e42e6"),
				common.HexToAddress("0x5B570EA42eBE010df95670389b93fd17d9Db9F23")},
			expectedValPositions: []byte{0, 1, 2, 255, 255, 255},
			expectedAddedVals: []common.Address{common.HexToAddress("0x31722d8C03e18a84891f45A4ECDe4444C8bE0907"),
				common.HexToAddress("0xB55A183bF5db01665f9fC5DfbA71Fc6f8b5e42e6"),
				common.HexToAddress("0x5B570EA42eBE010df95670389b93fd17d9Db9F23")},
		},
		...
		{
			// Test validator set reordering
			inputOldValset: []common.Address{common.HexToAddress("0x64DB1B94A0304E4c27De2E758B2f962d09dFE503"),
				common.HexToAddress("0xC257274276a4E539741Ca11b590B9447B26A8051"),
				common.HexToAddress("0x2140eFD7Ba31169c69dfff6CDC66C542f0211825"),
			},
			inputNewValset: []common.Address{common.HexToAddress("0xC257274276a4E539741Ca11b590B9447B26A8051"),
				common.HexToAddress("0x2140eFD7Ba31169c69dfff6CDC66C542f0211825"),
				common.HexToAddress("0x64DB1B94A0304E4c27De2E758B2f962d09dFE503"),
			},
			expectedValPositions: []byte{1, 2, 0},
			expectedAddedVals:    []common.Address{},
		},

		{
			// Test validator set reordering with addition between
			inputOldValset: []common.Address{common.HexToAddress("0x64DB1B94A0304E4c27De2E758B2f962d09dFE503"),
				common.HexToAddress("0xC257274276a4E539741Ca11b590B9447B26A8051"),
				common.HexToAddress("0x2140eFD7Ba31169c69dfff6CDC66C542f0211825"),
			},
			...
			expectedValPositions: []byte{1, 2, 255, 0, 255},
			expectedAddedVals: []common.Address{
				common.HexToAddress("0xB55A183bF5db01665f9fC5DfbA71Fc6f8b5e42e6"),
				common.HexToAddress("0xaF6532a62c7c7c951129cd55078B19216E81Dad9"),
			},
	...
	for i, tt := range tests {
		...
		valPositions, addedVals := SnarkValidatorSetDiff(convertedInputOldValSet, convertedInputNewValSet)
		addedValsAddresses, _ := SeparateValidatorDataIntoIstanbulExtra(addedVals)

		if !CompareValidatorSlices(addedValsAddresses, tt.expectedAddedVals) || !bytes.Equal(valPositions, tt.expectedValPositions) {
			t.Errorf("test %d failed - have: addedVals %v, valPositions %v; want: addedVals %v, valPositions %v", i, addedValsAddresses, valPositions, tt.expectedAddedVals, tt.expectedValPositions)
		}
		computedNewValSet := SnarkUpdateValSet(convertedInputOldValSet, valPositions, addedVals)
		computedNewValAddressees, _ := SeparateValidatorDataIntoIstanbulExtra(computedNewValSet)
