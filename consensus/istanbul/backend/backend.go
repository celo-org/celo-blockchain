...
func (sb *Backend) SendDelegateSignMsgToProxiedValidator(msg []byte) {
	...
	err := sb.proxiedPeer.Send(istanbul.DelegateSignMsg, msg)
	if err != nil {
		sb.logger.Error("Send to proxied peer failed", "err", err)
	}
}
