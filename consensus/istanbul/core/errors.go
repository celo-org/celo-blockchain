...
var (
	...
	// errProposalHashMismatch is returned when the proposal hash of a round change prepared certificate does not match the proposal's hash.
	errProposalHashMismatch = errors.New("Proposal hash mismatch in round change message")
