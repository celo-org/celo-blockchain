...
var (
	...
	// errBlockProcessResultNotFound is returned when result is not found in cache
	errBlockProcessResultNotFound = errors.New("failed to retrieve BlockProcessResult")
)
