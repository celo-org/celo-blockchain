...
func TestTxPool(t *testing.T) {
	...
	blockchain, _ := core.NewBlockChain(sdb, nil, params.TestChainConfig, mockEngine.NewFullFaker(), vm.Config{}, nil)
	gchain, _ := core.GenerateChain(params.TestChainConfig, genesis, mockEngine.NewFaker(), sdb, poolTestBlocks, txPoolTestChainGen)
	...
	lightchain, _ := NewLightChain(odr, params.TestChainConfig, mockEngine.NewFullFaker(), nil)
	txPermanent = 50
